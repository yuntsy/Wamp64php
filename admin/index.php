...
<form name="form1" method="post" action="chkadmin.php" onSubmit="return chkinput(this)">
  <table width="545" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
	<tr>
		<td height="226" background="images/1.png">&nbsp;</td>
	</tr>
	<tr>
		<td height="45" align="right" background="images/2.png"><table width="407" border="0" cellspacing="0" cellpadding="0">
          <tr>
	...
	<tr>
		<td height="23"  background="images/4.png"></td>
	</tr>
</table>
</form>
</body>
