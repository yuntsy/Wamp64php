...
<table width="209" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="153" background="images/denglu.png"><table width="209" border="0" cellspacing="0" cellpadding="0">
            <tr>
...
<a href="agreereg.php">注册</a>&nbsp;<a href="javascript:openfindpwd()">找回密码</a>&nbsp;</div></td>
        ...
        <tr>
          <td height="39"><img src="images/gonggao.png" width="209" height="39" border="0" usemap="#Map"></td>
        </tr>
        <tr>
          <td height="40" background="images/line3.png"><table width="180"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
        ...
        <tr>
          <td height="6" background="images/bline.png"></td>
        </tr>
        <tr>
          <td height="40" background="images/link.png">&nbsp;</td>
        </tr>
        <tr>
          <td valign="top" background="images/line3.png">
            <table width="180"  border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="180"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
